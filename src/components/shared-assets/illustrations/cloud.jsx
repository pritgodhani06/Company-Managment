...
export const sm = ({
  ...
  return <div {...otherProps} className={cx("relative h-30 w-38", className)}>
...
export const md = ({
  ...
  return <div {...otherProps} className={cx("relative h-32 w-43", className)}>
            <svg viewBox="0 0 182 137" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                ...
                <g filter="url(#filter-01-md)">
                    <path d="M93 16C79.534 16 67.6222 22.6541 60.3733 32.8536C58.0062 32.2954 55.5376 32 53 32C35.3269 32 21 46.3269 21 64C21 81.6731 35.3269 96 53 96H133C148.464 96 161 83.464 161 68C161 52.536 148.464 40 133 40C131.902 40 130.818 40.0633 129.752 40.1863C123.623 25.9596 109.475 16 93 16Z" className="fill-bg-secondary" />
...
export const lg = ({
  ...
  return <div {...otherProps} className={cx("relative h-40 w-55", className)}>
