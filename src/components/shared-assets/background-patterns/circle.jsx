...
const lg = props => {
  return <svg width="768" height="768" viewBox="0 0 768 768" fill="none" {...props} className={cx("text-border-secondary", props.className)}>
            <mask id="mask0_4933_392997" style={{
      maskType: "alpha"
    }} maskUnits="userSpaceOnUse" x="0" y="0" width="768" height="768">
            ...
            <defs>
                <radialGradient id="paint0_radial_4933_392997" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(384 384) rotate(90) scale(384 384)">
                    <stop />
...
const md = props => {
  return <svg width="480" height="480" viewBox="0 0 480 480" fill="none" {...props} className={cx("text-border-secondary", props.className)}>
            <mask id="mask0_4933_393068" style={{
      maskType: "alpha"
    }} maskUnits="userSpaceOnUse" x="0" y="0" width="480" height="480">
...
const sm = props => {
  return <svg width="336" height="336" viewBox="0 0 336 336" fill="none" {...props} className={cx("text-border-secondary", props.className)}>
            <mask id="mask0_4947_375931" style={{
      maskType: "alpha"
    }} maskUnits="userSpaceOnUse" x="0" y="0" width="336" height="336">
