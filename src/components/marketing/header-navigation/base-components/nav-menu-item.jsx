...
export const NavMenuItemLink = ({
  ...
  className,
  actionsContent
}) => <a href={href} className={cx("inline-flex w-full gap-3 px-4 py-3 outline-focus-ring transition duration-100 ease-linear hover:bg-primary_hover focus-visible:outline-2 sm:max-w-80 sm:p-3 md:rounded-lg", className)}>
