export const CircleProgressBar = props => {
  ...
  return <div role="progressbar" aria-valuenow={value} aria-valuemin={min} aria-valuemax={max} className="relative flex w-max items-center justify-center">
            ...
            <svg className="size-16 -rotate-90" viewBox="0 0 60 60">
                ...
                <circle className="stroke-fg-brand-primary" style={{
