...
export const Tooltip = ({
  ...
  return <AriaTooltipTrigger {...{
    ...
    onOpenChange
            ...
            <AriaTooltip {...tooltipProps} offset={offset} placement={placement} crossOffset={crossOffset ?? calculatedCrossOffset} className={({
      isEntering,
      isExiting
