...
export const UntitledLogoMinimal = props => {
  const id = useId();
  return <svg viewBox="0 0 38 38" fill="none" {...props} className={cx("size-8 origin-center scale-[1.2]", props.className)}>
            ...
            <defs>
                ...
                <radialGradient id={`paint4_radial-${id}`} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(19 14.6) rotate(90) scale(7)">
                    <stop stopColor="white" />
                    <stop offset="1" stopColor="white" stopOpacity="0" />
                </radialGradient>
